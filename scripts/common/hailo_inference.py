...
class HailoAsyncInference:
    def __init__(
        self, hef_path: str, input_queue: queue.Queue, callback: Callable, batch_size: int = 1,
            ...
            send_original_frame: bool = False, multi_process_service: bool = False,
        ...
        Args:
            ...
            multi_process_service (bool, optional): Share the physical Hailo device
                with other VDevices (e.g. another model already running) via the
                HailoRT multi-process scheduler, instead of claiming it exclusively.
                Defaults to False.
            group_id (str, optional): Scheduler group other multi-process-service
                VDevices must match to share this device. Defaults to "SHARED".
        """
